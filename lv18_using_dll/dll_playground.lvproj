...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="References" Type="Folder">
			<Item Name="json2csv.dll" Type="Document" URL="../dependencies/json2csv.dll"/>
		</Item>
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="dll Message Queue.lvlib" Type="Library" URL="../support/Message Queue/dll Message Queue.lvlib"/>
			<Item Name="dll User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/dll User Event - Stop.lvlib"/>
			<Item Name="dll Check Loop Error.vi" Type="VI" URL="../support/dll Check Loop Error.vi"/>
			<Item Name="dll Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/dll Error Handler - Event Handling Loop.vi"/>
			<Item Name="dll Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/dll Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="dll UI Data.ctl" Type="VI" URL="../controls/dll UI Data.ctl"/>
		</Item>
		<Item Name="adder_example.vi" Type="VI" URL="../adder_example.vi"/>
		<Item Name="dll Main.vi" Type="VI" URL="../dll Main.vi"/>
		<Item Name="json2csv.vi" Type="VI" URL="../json2csv.vi"/>
		<Item Name="json2csv_no_invokes_of_dependencies.vi" Type="VI" URL="../json2csv_no_invokes_of_dependencies.vi"/>
		<Item Name="string_concat_example.vi" Type="VI" URL="../string_concat_example.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="CsvHelper.dll" Type="Document" URL="../../json2csv/bin/Debug/netstandard2.0/publish/CsvHelper.dll"/>
			<Item Name="json2csv.dll" Type="Document" URL="../../json2csv/bin/Debug/netstandard2.0/json2csv.dll"/>
			<Item Name="Newtonsoft.Json.dll" Type="Document" URL="../../json2csv/bin/Debug/netstandard2.0/publish/Newtonsoft.Json.dll"/>
			<Item Name="UpDownCounter.dll" Type="Document" URL="../../UpDownCounter/bin/Debug/netstandard2.0/UpDownCounter.dll"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Main Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/dll Main.vi</Property>
